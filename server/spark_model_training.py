...
data = sqlContext.read.format('com.databricks.spark.csv').options(header='true', inferschema='true').load('FinalReview.csv')
...
# Reference : Assignment 3 of course CSCI 5408 Summer - 2018
